...
ALTER TABLE USERS ADD CONSTRAINT IF NOT EXISTS users_team_fk FOREIGN KEY (team) REFERENCES TEAM(teamid);
ALTER TABLE PLAYER ADD CONSTRAINT IF NOT EXISTS player_team_fk FOREIGN KEY (team) REFERENCES TEAM(teamid);
