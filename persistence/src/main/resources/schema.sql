...
ALTER TABLE USERS ADD CONSTRAINT users_team_fk FOREIGN KEY (team) REFERENCES TEAM(teamid) ON DELETE SET NULL;
ALTER TABLE PLAYER DROP CONSTRAINT IF EXISTS player_team_fk;
ALTER TABLE PLAYER ADD CONSTRAINT player_team_fk FOREIGN KEY (team) REFERENCES TEAM(teamid) ON DELETE CASCADE;
